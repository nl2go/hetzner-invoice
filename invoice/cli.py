...
@click.command()
@click.option("--user", help="Hetzner Account Username.")
@click.option("--pw", help="Hetzner Account Password.")
@click.option("--secret", help="Hetzner Account Base Secret.")
@click.option("--filepath", help="Where invoice file will be saved.")
def load_transform_invoice(user, pw, secret, filepath):
    """Program to automatically download and transform Hetzner invoice data"""
